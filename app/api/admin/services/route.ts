...
export async function POST(req: NextRequest) {
  try {
    ...
    const backendPayload = {
      ...
      form_questions: Array.isArray(p.formQuestions)
        ? p.formQuestions
        : [],
      ...
      // 🔥 YEH LINE ADD KARO → global addons ke IDs backend ko bhejne ke liye
      addon_ids: Array.isArray(p.addonIds) ? p.addonIds : [],
    };
