// app/api/provider/transactions/route.ts
...
export async function GET(req: NextRequest) {
  try {
    ...
    // ✅ REAL backend route
    const out = await serverFetch<any>(`${base()}/api/bookings/analytics/transactions${qs}`, {
      method: "GET",
      headers: {
        ...headers,
    ...
    console.error("GET /api/provider/transactions error:", e?.message);
